...
const tasks = [
  ...
  { key: 'fetchMaterialsList', label: 'Loading materials list...' },
  { key: 'fetchStoreLocationList', label: 'Loading Store Location list...' }
];
  ...
  useEffect(() => {
    const runTasks = async () => {
      for (let task of tasks) {
        await LoadData(task.key, userData.clientURL, userData.companyCode, userData.branchCode);
