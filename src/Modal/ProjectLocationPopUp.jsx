        ...
        >
            ...
            <View style={[globalStyles.popup, { backgroundColor: colors.background }]}>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={[styles.itemRow, globalStyles.twoInputContainer, { backgroundColor: colors.card }]}>
                            <TouchableOpacity
                                style={globalStyles.flex_1}
                                onPress={() => onSelect(item)}
                            >
                                <View style={[globalStyles.twoInputContainer1, globalStyles.justifyStart, { flexWrap: 'wrap', marginBottom: 5 }]}>
                            ...
                            <TouchableOpacity onPress={() => handleDelete(item)} style={globalStyles.justalignCenter}>
