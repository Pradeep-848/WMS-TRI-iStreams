...
// ---- DISPLAY NOTIFICATION USING NOTIFEE ----
export async function displayLocalLineNotification(title, body, lines = null) {
    try {
        const channelId = await notifee.createChannel({
            id: 'default',
            name: 'Default Channel',
        ...
        const iosBody = lines && Array.isArray(lines) ? lines.join('\n') : body;
        const androidBody = lines && Array.isArray(lines) ? lines[0] : body;
        ...
        // If lines provided and Android, use INBOX style
        ...
        console.log('displayLocalNotification error:', err);
    }
}
